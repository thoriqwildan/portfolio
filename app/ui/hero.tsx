    ...
    return (
        <div className="flex flex-row place-content-center max-w-full h-svh items-stretch ">
            <div className=" md:p-16 p-10 flex justify-center place-content-center flex-col md:items-center text-center md:text-start">
                ...
                <Link href={'#'} className='transition hover:scale-105 ease-in-out duration-300 m-7 bg-bluecustom rounded-lg px-10 py-2.5 text-sm '>Contact Me</Link>
                <Link href={'#'} className=' m-7 border rounded-lg px-12 py-2.5 text-sm'>My CV</Link>
                </div>
            </div>
        </div>
    )
